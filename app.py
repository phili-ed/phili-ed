...
limiter = Limiter(
    get_remote_address,
    app=app,
    default_limits = ["600 per days","120 per hour"],
    storage_uri="memory://",
)
...
class User(db.Model, UserMixin):
    ...
    # role level    0=non user (once per day)  1=pupil(once per hour)  2=premium/tutor clients(record Q reception/exclude done Q)  
